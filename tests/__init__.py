...
class TestParse(TestCase):
    ...
    def test_parser(self):
        ...
        expected = ContractMetaData(
            env_meta_bytes=b"\x00\x00\x00\x00\x00\x00\x00\x14\x00\x00\x00\x00",
            env_meta=[
                SCEnvMetaEntry(
            ...
            meta_bytes=b"\x00\x00\x00\x00\x00\x00\x00\x05rsver\x00\x00\x00\x00\x00\x00\x061.78.0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08rssdkver\x00\x00\x00/20.3.1#ba045a57af971fc83e475746b59a503b7ef41649\x00",
            meta=[
                SCMetaEntry(
            ...
            spec_bytes=b"\x00\x00\x00\x00\x00\x00\x00@Increment increments an internal counter, and returns the value.\x00\x00\x00\tincrement\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x04",
            spec=[
                SCSpecEntry(
